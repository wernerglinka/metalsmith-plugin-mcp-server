...
#### [v0.14.0](https://github.com/wernerglinka/metalsmith-plugin-mcp-server/compare/v0.13.0...v0.14.0)

> 31 July 2025

- **feat**: add comprehensive native methods validation to detect external dependencies
- **feat**: validate debug package usage and recommend metalsmith.debug()
- **feat**: validate minimatch package usage and recommend metalsmith.match()
- **feat**: validate process.env usage and recommend metalsmith.env()
- **feat**: validate path manipulation and recommend metalsmith.path()
- **fix**: move metalsmith from peerDependencies to devDependencies in plugin template
- **docs**: add Metalsmith Native Methods section to CLAUDE.md with critical usage patterns
- **docs**: update README.md with native methods validation features and examples
- **enhance**: plugin scaffolding now enforces zero external dependencies for common patterns
