...
#### [v0.6.2](https://github.com/wernerglinka/metalsmith-plugin-mcp-server/compare/v0.6.1...v0.6.2)

> 24 July 2025

- **fix**: Fix CLI validate command error handling to properly display validation results

#### [v0.4.0](https://github.com/wernerglinka/metalsmith-plugin-mcp-server/compare/v0.2.0...v0.4.0)

> 21 January 2025

**🚀 Major Update: Dual Module Support & Native Metalsmith Integration**

- **feat**: Add dual module support (ESM/CJS) using microbundle for generated plugins
- **feat**: Replace minimatch dependency with native Metalsmith `metalsmith.match()` method
- **feat**: Zero external runtime dependencies for generated plugins
- **feat**: Enhanced testing with both ESM and CJS test suites
- **feat**: Improved configuration merging with guaranteed property existence
- **feat**: Updated documentation with dual module development workflow
- **improvement**: Enhanced plugin templates with clearer pattern logic
- **improvement**: Better build process integration with automatic lib/ generation
- **improvement**: Comprehensive testing instructions for both module formats

This release significantly improves the generated plugin quality by eliminating external dependencies and providing native Metalsmith integration while supporting both modern ESM and legacy CommonJS environments.
